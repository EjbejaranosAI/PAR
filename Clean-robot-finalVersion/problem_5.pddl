(define (problem cleanTask_5)
 (:domain CleanerRobotTask)
   (:objects    boxRed boxBlue  boxGreen boxYellow robot 
                ofi-1 ofi-2 ofi-3 
                ofi-4 ofi-5 ofi-6
                ofi-7 ofi-8 ofi-9)
   (:init       (robot-at ofi-8)                
                ...
                (box-at boxRed ofi-4) (box-at boxYellow ofi-5) (is-empty ofi-6)
